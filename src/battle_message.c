...
const u8 gText_ForPetesSake[] = _("PROF.: Ora, haja paciência…\nInsistente, como sempre.\p{B_PLAYER_NAME}.\pVocê nunca teve uma batalha POKéMON\nantes, certo?\pUma batalha POKéMON é quando\nTREINADORES colocam seus POKéMONS\lum contra o outro.\p");
...
const u8 gText_KeepAnEyeOnHP[] = _("PROF.: Preste atenção no PS de\nseu POKéMON.\pIrá desmaiar se deixar o PS cair\npara “0.”\p");
const u8 gText_OakNoRunningFromATrainer[] = _("PROF.: Não! Não há como fugir de\numa batalha POKéMON com um\lTREINADOR!\p");
const u8 gText_WinEarnsPrizeMoney[] = _("PROF.: Hm! Excelente!\pSe você ganhar, ganha dinheiro\nrecompensa e seu POKéMON crescerá!\pBatalhe outros TREINADORES e faça\nde seus POKéMONS fortes!\p");
const u8 gText_HowDissapointing[] = _("PROF.: Hm…\nQue decepcionante…\pSe ganhasse, ganharia dinheiro\nrecompensa e seu POKéMON\lcresceria.\pMas como perdeu, {B_PLAYER_NAME}, você é\nquem tem de pagar…\pNo entanto, como ninguém te avisou\ndesta vez, pagarei por você.\pMas as coisas não serão assim quando\nvocê sair daqui afora.\pPor isso que deve fortalecer seus\nPOKéMONS batalhando outros\lPOKéMONS selvagens.\p");
...
const u8 gText_WhatWillPkmnDo[] = _("O que\n{B_ACTIVE_NAME_WITH_PREFIX} fará?");
