...
static const u8 sText_Trainer1RecallPkmn1[] = _("{B_TRAINER1_NAME}: {B_OPPONENT_MON1_NAME}, volte!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer1RecallPkmn2[] = _("{B_TRAINER1_NAME}: {B_OPPONENT_MON2_NAME}, volte!");
static const u8 sText_Trainer1RecallBoth[] = _("{B_TRAINER1_NAME}: {B_OPPONENT_MON1_NAME} e\n{B_OPPONENT_MON2_NAME}, voltem!");
static const u8 sText_Trainer2WinText[] = _("{B_TRAINER2_WIN_TEXT}");
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} ganhou\n{B_BUFF3} Pontos{B_BUFF2} de EXP.!\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" impulsionados");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} subiu para o\nNv. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} aprendeu\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} tenta aprender\n{B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("Mas, {B_BUFF1} não pode ter\nmais que quatro ataques.\p");
static const u8 sText_TryToLearnMove3[] = _("Deletar ataque para abrir\nespaço para {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} esqueceu\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}Deixar de aprender\n{B_BUFF2}?");
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} não aprendeu\n{B_BUFF2}.\p");
static const u8 sText_UseNextPkmn[] = _("Usar próximo POKéMON?");
static const u8 sText_AttackMissed[] = _("Ataque de {B_ATK_NAME_WITH_PREFIX}\nerra!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\nprotege-se!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} evitou\ndano com {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} faz ataques\nde TERRA errarem com {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} evitou\no ataque!");
static const u8 sText_ItDoesntAffect[] = _("Não afeta\n{B_DEF_NAME_WITH_PREFIX}…");
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\ndesmaiou!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\ndesmaiou!\p");
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} conseguiu ¥{B_BUFF1}\nao ganhar!\p");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} está sem\nPOKéMON utilizável!\p");
static const u8 sText_PlayerPanicked[] = _("{B_PLAYER_NAME} entra em pânico e perde\n¥{B_BUFF1}…\p… … … …\p{B_PLAYER_NAME} apagou!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("{B_PLAYER_NAME} está sem nenhum\nPOKéMON utilizável!\p{B_PLAYER_NAME} perde contra\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("{B_PLAYER_NAME} pagou ¥{B_BUFF1} como\nrecompensa…\p… … … …\p{B_PLAYER_NAME} apagou!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} apagou!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} previne\nfuga com {B_SCR_ACTIVE_ABILITY}!\p");
static const u8 sText_CantEscape2[] = _("Não pôde fugir!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} não pôde fugir!");
static const u8 sText_HitXTimes[] = _("Acertou {B_BUFF1} vez(es)!");
static const u8 sText_PkmnFellAsleep[] = _("{B_EFF_NAME_WITH_PREFIX}\ndormiu!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nfez {B_EFF_NAME_WITH_PREFIX} dormir!");
static const u8 sText_PkmnAlreadyAsleep[] = _("{B_DEF_NAME_WITH_PREFIX} já\ndorme!");
static const u8 sText_PkmnAlreadyAsleep2[] = _("{B_ATK_NAME_WITH_PREFIX} já\ndorme!");
static const u8 sText_PkmnWasntAffected[] = _("{B_DEF_NAME_WITH_PREFIX}\nnão se afetou!");
static const u8 sText_PkmnWasPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX}\nenvenenou-se!");
static const u8 sText_PkmnPoisonedBy[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nenvenena {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtByPoison[] = _("{B_ATK_NAME_WITH_PREFIX} sofre\npelo veneno!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} já sofre\ncom veneno.");
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} sofre\num veneno terrível!");
static const u8 sText_PkmnEnergyDrained[] = _("{B_DEF_NAME_WITH_PREFIX} teve sua\nenergia sugada!");
static const u8 sText_PkmnWasBurned[] = _("{B_EFF_NAME_WITH_PREFIX} se queima!");
static const u8 sText_PkmnBurnedBy[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nqueimou {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtByBurn[] = _("{B_ATK_NAME_WITH_PREFIX} sofre\npela queimadura!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} já tem\nqueimadura.");
static const u8 sText_PkmnWasFrozen[] = _("{B_EFF_NAME_WITH_PREFIX} \ncongela!");
static const u8 sText_PkmnFrozenBy[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\ncongelou {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnIsFrozen[] = _("{B_ATK_NAME_WITH_PREFIX} ainda\né gelo!");
...
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX} \ndescongelou com {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} paralisa-se!\nTalvez não se mova!");
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nparalisa {B_EFF_NAME_WITH_PREFIX}!\lTalvez não se mova!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} tem paralisia!\nNão pode se mover!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} já\ntem paralisia!");
static const u8 sText_PkmnHealedParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} não\ntem mais paralisia!");
static const u8 sText_PkmnDreamEaten[] = _("Sonho de {B_DEF_NAME_WITH_PREFIX}\nfoi devorado!");
...
static const u8 sText_TeamStoppedWorking[] = _("{B_BUFF1} de seu time\nparou de funcionar!");
static const u8 sText_FoeStoppedWorking[] = _("{B_BUFF1} oponente\nparou de funcionar!");
static const u8 sText_PkmnIsConfused[] = _("{B_ATK_NAME_WITH_PREFIX} ainda\nse confunde!");
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} acordou\nda sua confusão!");
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX}\nconfundiu-se!");
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} já\nsofre confusão!");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}\nse apaixona!");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} se apaixonou\npor {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX} não\nse move por paixão!");
static const u8 sText_PkmnBlownAway[] = _("{B_DEF_NAME_WITH_PREFIX}\nvoa para fora!");
static const u8 sText_PkmnChangedType[] = _("{B_ATK_NAME_WITH_PREFIX} transformou-se\nno tipo {B_BUFF1}!");
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX} hesitou!");
static const u8 sText_PkmnRegainedHealth[] = _("{B_DEF_NAME_WITH_PREFIX} recuperou\nsaúde!");
static const u8 sText_PkmnHPFull[] = _("PS de {B_DEF_NAME_WITH_PREFIX}\n está cheio!");
static const u8 sText_PkmnRaisedSpDef[] = _("{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumentou DEF.ESP!");
static const u8 sText_PkmnRaisedSpDefALittle[] = _("{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumentou DEF.ESP um pouco!");
static const u8 sText_PkmnRaisedDef[] = _("{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumentou DEFESA!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumentou DEFESA um pouco!");
static const u8 sText_PkmnCoveredByVeil[] = _("Equipe {B_ATK_PREFIX2}\nse cobre com um véu!");
static const u8 sText_PkmnUsedSafeguard[] = _("Equipe de {B_DEF_NAME_WITH_PREFIX} está protegida\npor SALVAGUARDA!");
static const u8 sText_PkmnSafeguardExpired[] = _("Equipe {B_ATK_PREFIX3} já não está\nprotegida por SALVAGUARDA!");
static const u8 sText_PkmnWentToSleep[] = _("{B_ATK_NAME_WITH_PREFIX} caiu\nno sono!");
static const u8 sText_PkmnSleptHealthy[] = _("{B_ATK_NAME_WITH_PREFIX} dormiu e\nficou saudável!");
static const u8 sText_PkmnWhippedWhirlwind[] = _("{B_ATK_NAME_WITH_PREFIX} criou\num redemoinho!");
static const u8 sText_PkmnTookSunlight[] = _("{B_ATK_NAME_WITH_PREFIX} pegou\nluz solar!");
static const u8 sText_PkmnLoweredHead[] = _("{B_ATK_NAME_WITH_PREFIX} abaixou\na cabeça!");
static const u8 sText_PkmnIsGlowing[] = _("{B_ATK_NAME_WITH_PREFIX} está brilhando!");
static const u8 sText_PkmnFlewHigh[] = _("{B_ATK_NAME_WITH_PREFIX} voou\nalto!");
static const u8 sText_PkmnDugHole[] = _("{B_ATK_NAME_WITH_PREFIX} cavou um\nburaco!");
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} esconde\ndentro d'água!");
static const u8 sText_PkmnSprangUp[] = _("{B_ATK_NAME_WITH_PREFIX} saltou para fora!");
static const u8 sText_PkmnSqueezedByBind[] = _("PRENDER de {B_ATK_NAME_WITH_PREFIX}\nespreme {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("{B_DEF_NAME_WITH_PREFIX} se prende\nem um vórtice!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX} se prende\nem um TÚMULO DE AREIA!");
static const u8 sText_PkmnWrappedBy[] = _("{B_ATK_NAME_WITH_PREFIX} ENROLA\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX} APERTOU\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtBy[] = _("{B_ATK_NAME_WITH_PREFIX} se fere\npor {B_BUFF1}!");
static const u8 sText_PkmnFreedFrom[] = _("{B_ATK_NAME_WITH_PREFIX} se liberta\nde {B_BUFF1}!");
static const u8 sText_PkmnCrashed[] = _("{B_ATK_NAME_WITH_PREFIX} continuou caindo\ne acertou o chão!");
const u8 gBattleText_MistShroud[] = _("{B_ATK_PREFIX2} se involveu\nem uma NÉVOA!");
static const u8 sText_PkmnProtectedByMist[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} se protege\npela NÉVOA!");
const u8 gBattleText_GetPumped[] = _("{B_ATK_NAME_WITH_PREFIX} está se\nagitando!");
static const u8 sText_PkmnHitWithRecoil[] = _("{B_ATK_NAME_WITH_PREFIX} sofre dano\nde recuo!");
static const u8 sText_PkmnProtectedItself2[] = _("{B_ATK_NAME_WITH_PREFIX} se\nprotegeu!");
static const u8 sText_PkmnBuffetedBySandstorm[] = _("{B_ATK_NAME_WITH_PREFIX} levou uma bofetada\nda tempestade de areia!");
static const u8 sText_PkmnPeltedByHail[] = _("{B_ATK_NAME_WITH_PREFIX} levou uma pedrada\nde GRANIZO!");
static const u8 sText_PkmnsXWoreOff[] = _("{B_BUFF1} de {B_ATK_PREFIX1}\nse esvaiu!");
static const u8 sText_PkmnSeeded[] = _("{B_DEF_NAME_WITH_PREFIX} se cobre de sementes!");
static const u8 sText_PkmnEvadedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} esquivou\ndo ataque!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("Saúde de {B_ATK_NAME_WITH_PREFIX} é\nsugada por SEMENTESSUGA!");
static const u8 sText_PkmnFastAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} ainda\ndorme.");
static const u8 sText_PkmnWokeUp[] = _("{B_ATK_NAME_WITH_PREFIX} acorda!");
static const u8 sText_PkmnUproarKeptAwake[] = _("Mas TUMULTO de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nnão deixa dormir!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} acordou\nno TUMULTO!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX} causou\num TUMULTO!");
static const u8 sText_PkmnMakingUproar[] = _("{B_ATK_NAME_WITH_PREFIX} está\nfazendo TUMULTO!");
static const u8 sText_PkmnCalmedDown[] = _("{B_ATK_NAME_WITH_PREFIX} se acalmou.");
static const u8 sText_PkmnCantSleepInUproar[] = _("Mas {B_DEF_NAME_WITH_PREFIX} não pode\ndormir no TUMULTO!");
static const u8 sText_PkmnStockpiled[] = _("{B_ATK_NAME_WITH_PREFIX} RESERVOU\n{B_BUFF1}!");
static const u8 sText_PkmnCantStockpile[] = _("{B_ATK_NAME_WITH_PREFIX} não pode\nRESERVAR mais!");
static const u8 sText_PkmnCantSleepInUproar2[] = _("Mas {B_DEF_NAME_WITH_PREFIX} não pode\ndormir no TUMULTO!");
static const u8 sText_UproarKeptPkmnAwake[] = _("Mas o TUMULTO manteve\n{B_DEF_NAME_WITH_PREFIX} sem dormir!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("{B_DEF_NAME_WITH_PREFIX} mantém-se\nalerta com {B_DEF_ABILITY}!");
static const u8 sText_PkmnStoringEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} guarda\nenergia!");
static const u8 sText_PkmnUnleashedEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} liberou\nenergia!");
static const u8 sText_PkmnFatigueConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} se confunde\ngraças a fadiga!");
static const u8 sText_PkmnPickedUpItem[] = _("{B_PLAYER_NAME} pegou\n¥{B_BUFF1}!\p");
static const u8 sText_PkmnUnaffected[] = _("{B_DEF_NAME_WITH_PREFIX} não\nse afeta!");
static const u8 sText_PkmnTransformedInto[] = _("{B_ATK_NAME_WITH_PREFIX} transformou\nem {B_BUFF1}!");
static const u8 sText_PkmnMadeSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} fez\num SUBSTITUTO!");
static const u8 sText_PkmnHasSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} já tem\num SUBSTITUTO!");
static const u8 sText_SubstituteDamaged[] = _("O SUBSTITUTO tomou dano\npor {B_DEF_NAME_WITH_PREFIX}!\p");
static const u8 sText_PkmnSubstituteFaded[] = _("SUBSTITUTO de\n{B_DEF_NAME_WITH_PREFIX} sumiu!\p");
static const u8 sText_PkmnMustRecharge[] = _("{B_ATK_NAME_WITH_PREFIX} deve\nrecarregar!");
static const u8 sText_PkmnRageBuilding[] = _("RAIVA de {B_DEF_NAME_WITH_PREFIX}\nse acumula!");
static const u8 sText_PkmnMoveWasDisabled[] = _("{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\nfoi desativado!");
static const u8 sText_PkmnMoveDisabledNoMore[] = _("{B_ATK_NAME_WITH_PREFIX} não está\nmais desativado!");
static const u8 sText_PkmnGotEncore[] = _("{B_DEF_NAME_WITH_PREFIX} fez\nBIS!");
static const u8 sText_PkmnEncoreEnded[] = _("BIS de {B_ATK_NAME_WITH_PREFIX}\nacabou!");
static const u8 sText_PkmnTookAim[] = _("{B_ATK_NAME_WITH_PREFIX} mirou\nem {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSketchedMove[] = _("{B_ATK_NAME_WITH_PREFIX} RASCUNHOU\n{B_BUFF1}!");
static const u8 sText_PkmnTryingToTakeFoe[] = _("{B_ATK_NAME_WITH_PREFIX} está tentando\nlevar oponente junto!");
static const u8 sText_PkmnTookFoe[] = _("{B_DEF_NAME_WITH_PREFIX} levou\n{B_ATK_NAME_WITH_PREFIX} junto!");
static const u8 sText_PkmnReducedPP[] = _("Reduziu {B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} com {B_BUFF2}!");
static const u8 sText_PkmnStoleItem[] = _("{B_ATK_NAME_WITH_PREFIX} roubou\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TargetCantEscapeNow[] = _("Agora {B_DEF_NAME_WITH_PREFIX} já não\nfoge mais!");
static const u8 sText_PkmnFellIntoNightmare[] = _("{B_DEF_NAME_WITH_PREFIX} caiu em\num PESADELO!");
static const u8 sText_PkmnLockedInNightmare[] = _("{B_ATK_NAME_WITH_PREFIX} se prende\nem um PESADELO!");
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} cortou o próprio PS\ne colocou uma MALDIÇÃO\lem {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("A MALDIÇÃO aflinge\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_SpikesScattered[] = _("PREGOS foram espalhados para\no lado oponente!");
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} se machuca\ncom PREGOS!");
static const u8 sText_PkmnIdentified[] = _("{B_ATK_NAME_WITH_PREFIX} identificou\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPerishCountFell[] = _("Contagem FATAL de\n{B_ATK_NAME_WITH_PREFIX} já está em {B_BUFF1}!");
static const u8 sText_PkmnBracedItself[] = _("{B_ATK_NAME_WITH_PREFIX} se\npreparou!");
static const u8 sText_PkmnEnduredHit[] = _("{B_DEF_NAME_WITH_PREFIX} RESISTIU\no impacto!");
static const u8 sText_MagnitudeStrength[] = _("MAGNITUDE {B_BUFF1}!");
static const u8 sText_PkmnCutHPMaxedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} cortou o próprio PS\ne maximizou o ATAQUE!");
static const u8 sText_PkmnCopiedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} copiou a\nmudança de status de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnGotFree[] = _("{B_ATK_NAME_WITH_PREFIX} se libertou de\n{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX} desprendeu\nSEMENTESSUGA!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX} soprou os\nPREGOS!");
static const u8 sText_PkmnFledFromBattle[] = _("{B_ATK_NAME_WITH_PREFIX} fugiu da\nbatalha!");
static const u8 sText_PkmnForesawAttack[] = _("{B_ATK_NAME_WITH_PREFIX} previu\num ataque!");
static const u8 sText_PkmnTookAttack[] = _("{B_DEF_NAME_WITH_PREFIX} tomou o\nataque {B_BUFF1}!");
static const u8 sText_PkmnChoseXAsDestiny[] = _("{B_ATK_NAME_WITH_PREFIX} escolheu\n{B_CURRENT_MOVE} como destino!");
static const u8 sText_PkmnAttack[] = _("Ataque de {B_BUFF1}!");
static const u8 sText_PkmnCenterAttention[] = _("{B_ATK_NAME_WITH_PREFIX} se torna o\ncentro das atenções!");
static const u8 sText_PkmnChargingPower[] = _("{B_ATK_NAME_WITH_PREFIX} começou a\ncarregar poder!");
static const u8 sText_NaturePowerTurnedInto[] = _("PODER NATURAL se tornou\n{B_CURRENT_MOVE}!");
static const u8 sText_PkmnStatusNormal[] = _("Status de {B_ATK_NAME_WITH_PREFIX}\nvoltou ao normal!");
static const u8 sText_PkmnSubjectedToTorment[] = _("{B_DEF_NAME_WITH_PREFIX} se sujeita\nao TORMENTO!");
static const u8 sText_PkmnTighteningFocus[] = _("{B_ATK_NAME_WITH_PREFIX} está prendendo\no foco!");
static const u8 sText_PkmnFellForTaunt[] = _("{B_DEF_NAME_WITH_PREFIX} caiu\nno PROVOQUE!");
static const u8 sText_PkmnReadyToHelp[] = _("{B_ATK_NAME_WITH_PREFIX} se prepara para\najudar {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwitchedItems[] = _("{B_ATK_NAME_WITH_PREFIX} trocou de\nitens com oponente!");
static const u8 sText_PkmnObtainedX[] = _("{B_ATK_NAME_WITH_PREFIX} obteve\n{B_BUFF1}.");
static const u8 sText_PkmnObtainedX2[] = _("{B_DEF_NAME_WITH_PREFIX} obteve\n{B_BUFF2}.");
static const u8 sText_PkmnObtainedXYObtainedZ[] = _("{B_ATK_NAME_WITH_PREFIX} obteve\n{B_BUFF1}.\p{B_DEF_NAME_WITH_PREFIX} obteve\n{B_BUFF2}.");
static const u8 sText_PkmnCopiedFoe[] = _("{B_ATK_NAME_WITH_PREFIX} copiou\n{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnMadeWish[] = _("{B_ATK_NAME_WITH_PREFIX} fez um DESEJO!");
static const u8 sText_PkmnWishCameTrue[] = _("DESEJO de {B_BUFF1}\ntornou-se realidade!");
static const u8 sText_PkmnPlantedRoots[] = _("{B_ATK_NAME_WITH_PREFIX} plantou suas raizes!");
static const u8 sText_PkmnAbsorbedNutrients[] = _("{B_ATK_NAME_WITH_PREFIX} absorveu\nnutrientes com suas raizes!");
static const u8 sText_PkmnAnchoredItself[] = _("{B_DEF_NAME_WITH_PREFIX} se ancorou\ncom suas raizes!");
static const u8 sText_PkmnWasMadeDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} fez\n{B_DEF_NAME_WITH_PREFIX} ter sono!");
static const u8 sText_PkmnKnockedOff[] = _("{B_ATK_NAME_WITH_PREFIX} derrubou\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwappedAbilities[] = _("{B_ATK_NAME_WITH_PREFIX} trocou habilidades\ncom oponente!");
static const u8 sText_PkmnSealedOpponentMove[] = _("{B_ATK_NAME_WITH_PREFIX} aprisionou o(s)\nataque(s) de oponente!");
static const u8 sText_PkmnWantsGrudge[] = _("{B_ATK_NAME_WITH_PREFIX} quer que\noponente guarde MÁGOA!");
static const u8 sText_PkmnLostPPGrudge[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} perdeu\ntodo PP por MÁGOA!");
static const u8 sText_PkmnShroudedItself[] = _("{B_ATK_NAME_WITH_PREFIX} se cobriu\ncom {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("{B_CURRENT_MOVE} de {B_ATK_NAME_WITH_PREFIX}\nricocheteou graças a CAPA MÁGICA!");
static const u8 sText_PkmnWaitsForTarget[] = _("{B_ATK_NAME_WITH_PREFIX} espera oponente\nfazer um ataque!");
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} ROUBOU\nataque de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ElectricityWeakened[] = _("Poder elétrico foi\nenfraquecido!");
static const u8 sText_FireWeakened[] = _("Poder de fogo foi\nenfraquecido!");
static const u8 sText_XFoundOneY[] = _("{B_ATK_NAME_WITH_PREFIX} achou\n{B_LAST_ITEM}!");
static const u8 sText_SoothingAroma[] = _("Um suave aroma soprou\npelo lugar!");
static const u8 sText_ItemsCantBeUsedNow[] = _("Itens não podem ser usados agora.{PAUSE 64}");
static const u8 sText_ForXCommaYZ[] = _("Para {B_SCR_ACTIVE_NAME_WITH_PREFIX},\n{B_BUFF1} {B_LAST_ITEM}");
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} usou\n{B_LAST_ITEM} para se agitar!");
static const u8 sText_PkmnLostFocus[] = _("{B_ATK_NAME_WITH_PREFIX} perdeu o\nfoco e não se moveu!");
static const u8 sText_PkmnWasDraggedOut[] = _("Arrastou {B_DEF_NAME_WITH_PREFIX}\npara fora!\p");
static const u8 sText_TheWallShattered[] = _("A parede quebrou!");
static const u8 sText_ButNoEffect[] = _("Mas não surtiu efeito!");
static const u8 sText_PkmnHasNoMovesLeft[] = _("{B_ACTIVE_NAME_WITH_PREFIX} não tem\nataques sobrando!\p");
static const u8 sText_PkmnMoveIsDisabled[] = _("{B_CURRENT_MOVE} de {B_ACTIVE_NAME_WITH_PREFIX}\nestá desabilitado!\p");
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_ACTIVE_NAME_WITH_PREFIX} não pode usar o mesmo\nataque seguido por TORMENTO!\p");
static const u8 sText_PkmnCantUseMoveTaunt[] = _("{B_ACTIVE_NAME_WITH_PREFIX} não pode usar\n{B_CURRENT_MOVE} por PROVOQUE!\p");
static const u8 sText_PkmnCantUseMoveSealed[] = _("{B_ACTIVE_NAME_WITH_PREFIX} não pode usar\n{B_CURRENT_MOVE} aprisionado!\p");
...
static const u8 sText_PkmnsXPreventsYsZ[] = _("{B_ATK_ABILITY} de {B_ATK_NAME_WITH_PREFIX}\nprevine {B_DEF_ABILITY} de\l{B_DEF_NAME_WITH_PREFIX} de funcionar!");
static const u8 sText_PkmnsXCuredItsYProblem[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\ncurou {B_BUFF1}!");
static const u8 sText_PkmnsXHadNoEffectOnY[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nnão surte efeito em {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_TooScaredToMove[] = _("{B_ATK_NAME_WITH_PREFIX} treme de medo e não se move!");
static const u8 sText_GetOutGetOut[] = _("FANTASMA: Saia daqui…… Saia daqui……");
const u8 gBattleText_Rose[] = _("subiu");
static const u8 sText_StatSharply[] = _(" abruptamente");
static const u8 sText_StatFell[] = _("caiu");
static const u8 sText_StatHarshly[] = _(" dramaticamente");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Usando {B_LAST_ITEM}, {B_BUFF1} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}!");
...
static const u8 sText_StatsWontIncrease2[] = _("Status de {B_ATK_NAME_WITH_PREFIX} já não\nsobem mais!");
static const u8 sText_StatsWontDecrease2[] = _("Status de {B_DEF_NAME_WITH_PREFIX} já não\ncaem mais!");
static const u8 sText_CriticalHit[] = _("Dano crítico!");
static const u8 sText_OneHitKO[] = _("É um nocaute num só golpe!");
...
static const u8 sText_AndEllipsis[] = _("E…\p");
static const u8 sText_HMMovesCantBeForgotten[] = _("Ataques de MSs não podem\nser deletados agora.\p");
static const u8 sText_NotVeryEffective[] = _("Não é muito efetivo…");
static const u8 sText_SuperEffective[] = _("É super efetivo!");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Conseguiu fugir!\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fugiu\nusando {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fugiu\nusando {B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}{B_BUFF1} selvagem fugiu!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("{B_PLAYER_NAME} derrotou\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("{B_PLAYER_NAME} vence {B_LINK_OPPONENT1_NAME}\ne {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("{B_PLAYER_NAME} perde contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerLostToTwo[] = _("{B_PLAYER_NAME} perde para {B_LINK_OPPONENT1_NAME}\ne {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("{B_PLAYER_NAME} empata contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("{B_PLAYER_NAME} empata contra\n{B_LINK_OPPONENT1_NAME} e {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} fugiu!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} e\n{B_LINK_OPPONENT2_NAME} fugiram!");
static const u8 sText_NoRunningFromTrainers[] = _("Não! Não se deve fugir de\numa batalha de TREINADOR!\p");
static const u8 sText_CantEscape[] = _("Não pôde fugir!\p");
static const u8 sText_DontLeaveBirch[] = _(""); // Dummied
static const u8 sText_ButNothingHappened[] = _("Mas nada aconteceu!");
static const u8 sText_ButItFailed[] = _("Mas falhou!");
static const u8 sText_ItHurtConfusion[] = _("Se machucou na sua\nconfusão!");
static const u8 sText_MirrorMoveFailed[] = _("ESPELHAR falhou!");
static const u8 sText_StartedToRain[] = _("Começou a chover!");
static const u8 sText_DownpourStarted[] = _("Uma garoa começa!"); // corresponds to DownpourText in pokegold and pokecrystal and is used by Rain Dance in GSC
static const u8 sText_RainContinues[] = _("A chuva continua a cair.");
static const u8 sText_DownpourContinues[] = _("A garoa continua."); // unused
static const u8 sText_RainStopped[] = _("A chuva parou.");
static const u8 sText_SandstormBrewed[] = _("Uma tempestade de areia levanta!");
static const u8 sText_SandstormRages[] = _("A tempestade só piora.");
static const u8 sText_SandstormSubsided[] = _("A tempestade se afasta.");
static const u8 sText_SunlightGotBright[] = _("A luz solar brilha mais!");
static const u8 sText_SunlightStrong[] = _("O sol continua forte.");
static const u8 sText_SunlightFaded[] = _("O sol esfria.");
static const u8 sText_StartedHail[] = _("Começa a cair granizo!");
static const u8 sText_HailContinues[] = _("Granizo continua a cair.");
static const u8 sText_HailStopped[] = _("O granizo parou.");
static const u8 sText_FailedToSpitUp[] = _("Mas não pôde CUSPIR\nalgo!");
static const u8 sText_FailedToSwallow[] = _("Mas não pôde ENGOLIR\nalgo!");
static const u8 sText_WindBecameHeatWave[] = _("O vento se tornou uma\nONDA DE CALOR!");
static const u8 sText_StatChangesGone[] = _("Todas mudanças de status\nforam eliminadas!");
static const u8 sText_CoinsScattered[] = _("Moedas se espalham por tudo!");
static const u8 sText_TooWeakForSubstitute[] = _("Está muito fraco para criar\num SUBSTITUTO!");
static const u8 sText_SharedPain[] = _("Os batalhadores compartilham\nsua dor!");
static const u8 sText_BellChimed[] = _("O sino badala!");
static const u8 sText_FaintInThree[] = _("Todos POKéMONS afetados\ndesmaiarão em três turnos!");
static const u8 sText_NoPPLeft[] = _("Não há PP restando para\neste ataque!\p");
static const u8 sText_ButNoPPLeft[] = _("Mas não havia PP restante\npara o ataque!");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} ignorou\nordens dormindo!");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX} ignorou\nordens!");
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} tirou uma soneca!");
static const u8 sText_PkmnLoafing[] = _("{B_ATK_NAME_WITH_PREFIX} está\nvadiando!");
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX} não\nobedece!");
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX} se virou!");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX} finge\nignorância!");
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} está\nprestes a usar {B_BUFF2}.\p{B_PLAYER_NAME} irá trocar\nde POKéMON?");
static const u8 sText_PkmnLearnedMove2[] = _("{B_ATK_NAME_WITH_PREFIX} aprendeu\n{B_BUFF1}!");
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("{B_PLAYER_NAME} derrotou\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p");
static const u8 sText_ThrewARock[] = _("{B_PLAYER_NAME} atirou uma PEDRA\nem {B_OPPONENT_MON1_NAME}!");
static const u8 sText_ThrewSomeBait[] = _("{B_PLAYER_NAME} jogou uma ISCA\npara {B_OPPONENT_MON1_NAME}!");
static const u8 sText_PkmnWatchingCarefully[] = _("{B_OPPONENT_MON1_NAME} observa\ncautelosamente!");
static const u8 sText_PkmnIsAngry[] = _("{B_OPPONENT_MON1_NAME} se irrita!");
static const u8 sText_PkmnIsEating[] = _("{B_OPPONENT_MON1_NAME} está comendo!");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}APRESENTANTE: Você está sem\nBOLAS SAFARI! Fim de jogo!\p");
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} selvagem apareceu!\p");
static const u8 sText_WildPkmnAppeared2[] = _("{B_OPPONENT_MON1_NAME} selvagem apareceu!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME} selvagem apareceu!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} e\n{B_OPPONENT_MON2_NAME} selvagens aparecem!\p");
static const u8 sText_GhostAppearedCantId[] = _("O FANTASMA apareceu!\pDroga!\nO FANTASMA não pode ser identificado!\p");
static const u8 sText_TheGhostAppeared[] = _("O FANTASMA apareceu!\p");
static const u8 sText_SilphScopeUnveil[] = _("SILPH SCOPE revelou a identidade\ndo FANTASMA!");
static const u8 sText_TheGhostWas[] = _("O FANTASMA era BATUTANO!\p\n");
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\ngostaria de batalhar!\p");
static const u8 sText_Trainer2WantsToBattle[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\ngostariam de batalhar!\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("{B_LINK_OPPONENT1_NAME}\nquer batalhar!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} e {B_LINK_OPPONENT2_NAME}\nquerem batalhar!");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nmandou {B_OPPONENT_MON1_NAME}!{PAUSE 60}");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nmandaram {B_OPPONENT_MON1_NAME} e {B_OPPONENT_MON2_NAME}!{PAUSE 60}");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nmandou {B_BUFF1}!");
static const u8 sText_LinkTrainerSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME}\nmandou {B_OPPONENT_MON1_NAME}!");
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{B_LINK_OPPONENT1_NAME} mandou\n{B_OPPONENT_MON1_NAME} e {B_OPPONENT_MON2_NAME}!");
static const u8 sText_TwoLinkTrainersSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} mandou {B_LINK_OPPONENT_MON1_NAME}!\n{B_LINK_OPPONENT2_NAME} mandou {B_LINK_OPPONENT_MON2_NAME}!");
...
static const u8 sText_GoTwoPkmn[] = _("Vai! {B_PLAYER_MON1_NAME} e\n{B_PLAYER_MON2_NAME}!");
static const u8 sText_GoPkmn2[] = _("Vai! {B_BUFF1}!");
static const u8 sText_DoItPkmn[] = _("Vá! {B_BUFF1}!");
static const u8 sText_GoForItPkmn[] = _("Você consegue, {B_BUFF1}!");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("Já enfraqueceu!\nPega eles, {B_BUFF1}!");
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME} mandou {B_LINK_PLAYER_MON2_NAME}!\nVai! {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, basta!\nVolte!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, volte!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, OK!\nVolte!");
const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, ótimo!\nVolte!");
...
static const u8 sText_WildPkmnPrefix[] = _(" selvagem");
static const u8 sText_FoePkmnPrefix[] = _(" oponente");
static const u8 sText_FoePkmnPrefix2[] = _("inimiga");
static const u8 sText_AllyPkmnPrefix[] = _("aliada");
static const u8 sText_FoePkmnPrefix3[] = _("inimiga");
static const u8 sText_AllyPkmnPrefix2[] = _("aliada");
static const u8 sText_FoePkmnPrefix4[] = _("inimiga");
static const u8 sText_AllyPkmnPrefix3[] = _("aliada");
static const u8 sText_AttackerUsedX[] = _("{B_ATK_NAME_WITH_PREFIX} usou\n{B_BUFF2}");
...
static const u8 sText_Defense2[] = _("DEFESA");
...
static const u8 sText_Evasiveness[] = _("Desvio");
...
static const u8 sText_PokeblockWasTooSpicy[] = _("estava muito ardido!"); //
static const u8 sText_PokeblockWasTooDry[] = _("estava muito seco!");
static const u8 sText_PokeblockWasTooSweet[] = _("estava muito doce!");
static const u8 sText_PokeblockWasTooBitter[] = _("estava muito amargo!");
static const u8 sText_PokeblockWasTooSour[] = _("estava muito azedo!");
...
static const u8 sText_PlayerUsedItem[] = _("{B_PLAYER_NAME} usou\n{B_LAST_ITEM}!");
static const u8 sText_OldManUsedItem[] = _("O velho usou\n{B_LAST_ITEM}!");
static const u8 sText_PokedudeUsedItem[] = _("O POKé MANO usou\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nusou {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("O TREINADOR bloqueou a BOLA!");
static const u8 sText_DontBeAThief[] = _("Não seja ladrão!");
static const u8 sText_ItDodgedBall[] = _("Desviou-se da BOLA!\nNão pode capturar este POKéMON!");
static const u8 sText_YouMissedPkmn[] = _("Você errou o POKéMON!");
static const u8 sText_PkmnBrokeFree[] = _("Ah, não!\nO POKéMON se libertou!");
static const u8 sText_ItAppearedCaught[] = _("Awn!\nParecia que tinha pego!");
static const u8 sText_AarghAlmostHadIt[] = _("Aahh!\nQuase consegui!");
static const u8 sText_ShootSoClose[] = _("Droga!\nE tão perto, também!");
static const u8 sText_ItDodgedBall2[] = _("よけられた!\nこいつは つかまりそうにないぞ!"); // Unused version of the Marowak ghost dodging text
static const u8 sText_GotchaPkmnCaught[] = _("É isso aí!\nCapturei {B_OPPONENT_MON1_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("É isso aí!\nCapturei {B_OPPONENT_MON1_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("Dar um apelido\na {B_OPPONENT_MON1_NAME}?");
static const u8 sText_PkmnSentToPC[] = _("Guardou {B_OPPONENT_MON1_NAME} no\nPC {B_PC_CREATOR_NAME}.");
static const u8 sText_Someones[] = _("de alguém");
static const u8 sText_Bills[] = _("do BILL");
static const u8 sText_PkmnDataAddedToDex[] = _("Dados de {B_OPPONENT_MON1_NAME} foram\nadicionados a POKéDEX.\p");
static const u8 sText_ItIsRaining[] = _("Está chovendo."); // used only in RSE when a battle starts in a rainy area
static const u8 sText_SandstormIsRaging[] = _("Há uma tempestade de areia.");
static const u8 sText_BoxIsFull[] = _("A CAIXA está cheia!\nNão pode mais capturar!\p");
static const u8 sText_EnigmaBerry[] = _("FRUTA ENIGMA");
static const u8 sText_BerrySuffix[] = _(" FRUTA");
...
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_LAST_ITEM} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nrestaurou PP de {B_BUFF1}!");
static const u8 sText_PkmnsItemRestoredStatus[] = _("{B_LAST_ITEM} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nrestaurou o status!");
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_LAST_ITEM} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nrestaurou o PS um pouco!");
static const u8 sText_ItemAllowsOnlyYMove[] = _("Efeito de {B_LAST_ITEM} só permite\n{B_CURRENT_MOVE} de ser usado!\p");
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX} aguentou\nusando {B_LAST_ITEM}!");
const u8 gText_EmptyString3[] = _("");
static const u8 sText_PlayedFluteCatchyTune[] = _("{B_PLAYER_NAME} tocou a {B_LAST_ITEM}.\pEssa música é boa!");
static const u8 sText_PlayedThe[] = _("{B_PLAYER_NAME} tocou\na {B_LAST_ITEM}.");
static const u8 sText_PkmnHearingFluteAwoke[] = _("Os POKéMONS adormecidos\nacordaram!");
static const u8 sText_YouThrowABallNowRight[] = _("Você joga a BOLA agora, né?\nEu… Eu vou dar meu melhor!");
const u8 gText_ForPetesSake[] = _("PROF.: Ora, haja paciência…\nInsistente, como sempre.\p{B_PLAYER_NAME}.\pVocê nunca esteve em uma\nbatalha POKéMON antes, certo?\pUma batalha POKéMON é quando\nTREINADORES colocam seus POKéMONS\lum contra o outro.\p");
const u8 gText_TheTrainerThat[] = _("O TREINADOR que fizer o POKéMON\ndo outro TREINADOR desmaiar\ldiminuindo seu PS a “0”, ganha.\p");
const u8 gText_TryBattling[] = _("Mas ao invés de falar, que tal\naprender mais com experiência?\pTente batalhar e veja por conta\nprópria.\p");
const u8 gText_InflictingDamageIsKey[] = _("PROF.: Inflingir dano no oponente\né o caminho para vencer.\p");
const u8 gText_LoweringStats[] = _("PROF.: Diminuir o status do oponente\nte dará uma vantagem.\p");
const u8 gText_KeepAnEyeOnHP[] = _("PROF.: Preste bem atenção no PS\nde seus POKéMONS.\pEles desmaiam se deixar o PS cair\npara “0”.\p");
const u8 gText_OakNoRunningFromATrainer[] = _("PROF.: Não! Você não pode fugir\nde uma batalha POKéMON com\lum TREINADOR!\p");
const u8 gText_WinEarnsPrizeMoney[] = _("PROF.: Hm! Excelente!\pQuando você ganha, você pega\ndinheiro de recompensa e seus\lPOKéMONS crescem!\pBatalhe outros TREINADORES e faça\nde seus POKéMONS mais fortes!\p");
const u8 gText_HowDissapointing[] = _("PROF.: Hm…\nQue decepcionante…\pSe tivesse ganhado, pegaria dinheiro\nde recompensa e seus POKéMONS\lcresceriam.\pMas como perdeu, {B_PLAYER_NAME}, você é\nquem tem de pagar…\pNo entanto, como ninguém te avisou\ndesta vez, pagarei por você.\pMas as coisas não serão assim quando\nvocê sair daqui afora.\pPor isso que deve fortalecer seus\nPOKéMONS batalhando outros\lPOKéMONS selvagens.\p");
...
const u8 gText_PkmnIsEvolving[] = _("O quê?\n{STR_VAR_1} está evoluindo!");
const u8 gText_CongratsPkmnEvolved[] = _("Parabéns! {STR_VAR_1}\nevoluiu para {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedEvolving[] = _("Hã? {STR_VAR_1}\nparou de evoluir!\p");
const u8 gText_EllipsisQuestionMark[] = _("……?\p");
const u8 gText_WhatWillPkmnDo[] = _("O que {B_ACTIVE_NAME_WITH_PREFIX}\nirá fazer?");
const u8 gText_WhatWillPlayerThrow[] = _("O que {B_PLAYER_NAME}\njogará?");
const u8 gText_WhatWillOldManDo[] = _("O que o\nvelho fará?");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Link em espera…");
const u8 gText_BattleMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}LUTAR{CLEAR_TO 56}BOLSA\nPOKéMON{CLEAR_TO 56}FUGIR");
const u8 gText_SafariZoneMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}BOLA{CLEAR_TO 56}ISCA\nPEDRA{CLEAR_TO 56}FUGIR");
...
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Sim\nNão");
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Trocar\nqual?");
...
const u8 gText_HighlightRed_Left[] = _("{HIGHLIGHT 2}Total: ");
const u8 gText_HighlightRed[] = _("{HIGHLIGHT 2}");
const u8 gText_Sleep[] = _("dormir");
const u8 gText_Poison[] = _("veneno");
const u8 gText_Burn[] = _("queimar");
const u8 gText_Paralysis[] = _("paralisia");
const u8 gText_Ice[] = _("congelar");
const u8 gText_Confusion[] = _("confusão");
...
const u8 gText_BattleTowerBan_Is1[] = _(" é");
const u8 gText_BattleTowerBan_Is2[] = _(" é");
const u8 gText_BadEgg[] = _("OVO Ruim");
const u8 gText_BattleWallyName[] = _("ミツル");
const u8 gText_Win[] = _("{HIGHLIGHT 0}Venceu");
const u8 gText_Loss[] = _("{HIGHLIGHT 0}Perdeu");
const u8 gText_Draw[] = _("{HIGHLIGHT 0}Empate");
static const u8 sText_SpaceIs[] = _(" é");
static const u8 sText_ApostropheS[] = _(" de");
const u8 gText_ANormalMove[] = _("um ataque NORMAL");
const u8 gText_AFightingMove[] = _("um ataque LUTADOR");
const u8 gText_AFlyingMove[] = _("um ataque VOADOR");
const u8 gText_APoisonMove[] = _("um ataque VENENO");
const u8 gText_AGroundMove[] = _("um ataque TERRA");
const u8 gText_ARockMove[] = _("um ataque ROCHA");
const u8 gText_ABugMove[] = _("um ataque INSETO");
const u8 gText_AGhostMove[] = _("um ataque FANTASMA");
const u8 gText_ASteelMove[] = _("um ataque AÇO");
const u8 gText_AMysteryMove[] = _("um ataque ???");
const u8 gText_AFireMove[] = _("um ataque FOGO");
const u8 gText_AWaterMove[] = _("um ataque ÁGUA");
const u8 gText_AGrassMove[] = _("um ataque GRAMA");
const u8 gText_AnElectricMove[] = _("um ataque ELÉTRICO");
const u8 gText_APsychicMove[] = _("um ataque PSÍQUICO");
const u8 gText_AnIceMove[] = _("um ataque GELO");
const u8 gText_ADragonMove[] = _("um ataque DRAGÃO");
const u8 gText_ADarkMove[] = _("um ataque ESCURO");
const u8 gText_TimeBoard[] = _("QUADRO TEMPO");
const u8 gText_ClearTime[] = _("TEMPO TÉRMINO"); // Unused
...
static const u8 sText_Trainer1Fled[] = _("{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} fugiu!");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("{B_PLAYER_NAME} perdeu contra\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("{B_PLAYER_NAME} empatou com\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!");
    ...
    case STRINGID_INTROMSG: // first battle msg
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        {
            ...
            else
            {
                ...
                {
					stringPtr = sText_Trainer2WantsToBattle;
                }
                else
                {
					stringPtr = sText_Trainer1WantsToBattle;
