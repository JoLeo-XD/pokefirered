...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ROCKET_GRUNT_M]         = TRAINER_CLASS_TEAM_ROCKET_GRUNT,
    [FACILITY_CLASS_COOLTRAINER_M]          = TRAINER_CLASS_COOLTRAINER,
    [FACILITY_CLASS_COOLTRAINER_F]          = TRAINER_CLASS_COOLTRAINER,
    [FACILITY_CLASS_ELITE_FOUR_LORELEI]     = TRAINER_CLASS_ELITE_FOUR_1,
    [FACILITY_CLASS_ELITE_FOUR_BRUNO]       = TRAINER_CLASS_ELITE_FOUR_2,
    ...
    [FACILITY_CLASS_ROCKET_GRUNT_F]         = TRAINER_CLASS_TEAM_ROCKET_GRUNT,
    ...
    [FACILITY_CLASS_ELITE_FOUR_AGATHA]      = TRAINER_CLASS_ELITE_FOUR_3,
    [FACILITY_CLASS_ELITE_FOUR_LANCE]       = TRAINER_CLASS_ELITE_FOUR_4,
